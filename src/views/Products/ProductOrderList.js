...
<Grid container spacing={10}>
  <Grid item md={6} style={{padding:'50px 125px'}}>
    <img style={{margin:'auto' ,boxShadow: '10px 10px 5px #ccc', borderRadius:'15px'}} src={this.props.allProducts.find(product=> product.id === parseInt(this.props.match.params.id,10)).image_url} alt="" height="300" width="400"/>
  </Grid>
  <Grid item md={6}>
    <Grid item md={12}>
      <form onSubmit={this.handleSubmitOrderSearch} className="input-center">
          <div onChange={this.handleRadioButton}>
            <label><input style={{height:'16px'}} type="radio" value="All Order" name="All Order" checked={this.props.productOrderRadio === "All Order"} onChange={this.handleRadioButton}/>&nbsp;&nbsp;All Order</label>&nbsp;&nbsp;
            <label><input style={{height:'16px'}} type="radio" value="On Order" name="On Order" checked={this.props.productOrderRadio === "On Order"} onChange={this.handleRadioButton}/>&nbsp;&nbsp;On Order</label>&nbsp;&nbsp;
            <label><input style={{height:'16px'}} type="radio" value="Received" name="Received" checked={this.props.productOrderRadio === "Received"} onChange={this.handleRadioButton}/>&nbsp;&nbsp;Received</label>&nbsp;&nbsp;
          </div>
