...
const CreateNewItem = (props) => {
  ...
  function handleCreateNewItem(event) {
    event.preventDefault();
    let mongo_image_url = "http://localhost:5000/images/"+image_name;
      ...
      <form className="new-item-form" onSubmit={handleCreateNewItem}>
        ...
        <div className="input-div">
          ...
          <input
            ...
            value={props.barcode}
            name="barcode"
            onChange={(event) => props.newBarcode(event)}
            required
          />
        </div>
        <div className="input-div">
          ...
          <input
            className="right-label"
            type="number"
            value={props.retail_price}
            step="1"
            onChange={(event) => props.newRetailPrice(event)}
            required
          />
        </div>
        <div className="input-div">
          ...
          <input
            className="right-label"
            type="number"
            value={props.pomo_price}
            step="1"
            onChange={(event) => props.newPomoPrice(event)}
            required
          />
        </div>
        <div className="input-div">
          ...
          <input
            className="right-label"
            type="number"
            value={props.last_cost}
            step="1"
            onChange={(event) => props.newLastCost(event)}
            required
          />
        </div>
        <div className="input-div">
          ...
          <input
            className="right-label"
            type="text"
            value={props.most_recent_vendor}
            onChange={(event) => props.newMostRecentVendor(event)}
            required
          />
        </div>
        <div className="input-div">
          ...
          <input
            ...
            type="text"
            value={props.unit}
            onChange={(event) => props.newProductUnit(event.target.value)}
            required
          />
        </div>
        <div className="input-div">
          ...
          <input
            ...
            type="text"
            value={props.status}
            onChange={(event) => props.newStatus(event)}
            required
          />
        </div>
        <div className="input-div">
          ...
          <input
            className="right-label"
            type="text"
            value={props.forecast_sales_three_months}
            onChange={(event) => props.newForecast(event)}
          />
        </div>
        <div className="input-div">
          <label className="left-label">
          ...
          <input
            className="right-label"
            type="text"
            value={props.need_to_order_for_next_three_months}
            onChange={(event) => props.newNeedToOrder(event)}
          />
        </div>
        <div className="input-div">
          ...
          <input
            className="right-label"
            type="text"
            value={props.annualized_sales}
            onChange={(event) => props.newAnnualizedSales(event)}
          />
        </div>
        <div className="input-div">
          ...
          <input
            className="right-label"
            type="text"
            value={props.annualized_qty}
            onChange={(event) => props.newAnnualizedQty(event)}
          />
        </div>
        <div className="input-div">
          ...
          <input
            ...
            onChange={(event) => props.newCategory(event)}
            required
          />
        </div>
{/*      
...
function mapStateToProps(state) {
  return {
    ...
    need_to_order_for_next_three_months:
      state.need_to_order_for_next_three_months,
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    newNeedToOrder: (event) => {
      dispatch({
        type: "NEW_NEED_TO_ORDER_INPUT",
        payload: event.target.value,
      });
    },
    newAnnualizedSales: (event) => {
      dispatch({
        type: "NEW_ANNUALIZED_SALES_INPUT",
        payload: event.target.value,
      });
    },
    newAnnualizedQty: (event) => {
      dispatch({
        type: "NEW_ANNUALIZED_QTY_INPUT",
        payload: event.target.value,
      });
    },
    newCategory: (event) => {
